...
*Pricing scales with platforms and cadence.
Final price locked at onboarding. Terms apply.

#SocialMediaMarketing #ContentMarketing #SmallBusinessSA
#SouthAfricanBusiness #MarketingAutomation #BrandVoice
...
```
A question for solar installers 🤔
...
When product positioning, pricing, or compliance language changes:

1. Update `docs/website/Product_5W_Strategy.md` first (the SSOT)
2. Update `docs/website/Product_Deep_Links.md` (URL conventions, table)
3. Refresh this file's per-platform copy to match
4. Cross-check: every pricing claim has an asterisk + terms link, no invented numbers, no em dashes, no AI-tell phrases ("delve," "leverage," "unlock," "in today's fast-paced world")
