    ...
    function renderEstimate() {
        ...
        return ''
            ...
            + '<div class="build-popup-est-disclaimer">'
                ...
                + '<p>This is a starting estimate based on the four answers above, not a binding quote. Real numbers come from a 15-min scoping call. Projects with extra complexity (regulated industries, banking-grade security, large user bases) take additional discovery. <a href="' + buildTermsPath() + '#pricing" target="_blank" rel="noopener">Read our fair-build terms →</a></p>'
            + '</div>'
            + '<div class="build-popup-actions">'
                + '<button type="button" class="btn-back" data-action="back">← Back</button>'
        ...
        return ''
            ...
            + '<form id="build-popup-form" novalidate>'
                ...
                + '<div class="build-popup-consent">'
                    ...
                    + '<label for="bp-consent">I understand this is a starting estimate, not a binding quote. Final pricing follows a scoping call and our <a href="' + buildTermsPath() + '#pricing" target="_blank" rel="noopener">fair-build terms</a>.</label>'
                + '</div>'
