    ...
    overlay.innerHTML =
        ...
        '<div class="exit-popup-card">' +
            '<button class="exit-popup-close" aria-label="Close">' +
                '<svg style="width: 1.5rem; height: 1.5rem" class="hi" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12"/>
</svg>' +
            '</button>' +
            '<div class="exit-popup-icon">' +
                '<svg style="width: 1.75rem; height: 1.75rem" class="hi" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon">
