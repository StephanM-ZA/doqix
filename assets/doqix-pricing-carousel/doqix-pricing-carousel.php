...
/* ── Constants ── */
define( 'DOQIX_PRICING_VERSION',    '1.1.1' );
...
function doqix_pricing_maybe_migrate() {
	...
	// ── 1.1.1: One-time reset — replace default preset cards with Pricing Strategy v2.0 data
	if ( version_compare( $stored_version, '1.1.1', '<' ) ) {
